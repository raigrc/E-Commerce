...
include './conn.php';
  ...
  $get_orders = "SELECT o.order_id, o.customer_id, o.prod_id, o.quantity AS order_quantity, o.order_date, o.order_status, p.*, c.*
  FROM orders o, products p, customers c
  WHERE o.prod_id = p.prod_id AND o.customer_id = c.customer_id";
  $get_result = mysqli_query($mysqli, $get_orders);
?>
